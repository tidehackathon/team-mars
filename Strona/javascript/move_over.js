...
function onPointerMove (event) {
  ...
  var tempY = viewBox.y -(pointerPosition.y - pointerOrigin.y);
    // if (tempY > -70){
    //   viewBox.y = -70
    // }
    // // else if (tempY < -200) {
  ...
  // var tempX = viewBox.x - (pointerPosition.x - pointerOrigin.x);
  //   if (tempX < -200){
  //     newViewBox.x = -200
  //   }
  //   else if (tempX > 700)
  ...
  event.currentTarget.setAttribute('viewBox', viewBoxString);
